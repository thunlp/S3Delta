...
def main():
    ...
    if delta_args.delta_type.lower() != "none":
        ...
        print(f'num_trainable_parameters: {delta_model.num_trainable_parameters(model)/1024**2}')
...
if __name__ == "__main__":
    import sys, os
    # sys.argv = ['examples/examples_seq2seq/run_seq2seq.py', 'examples/examples_seq2seq/configs/adapter_t5-base/cola_copy.json']
